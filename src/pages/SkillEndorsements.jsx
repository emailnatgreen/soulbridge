...
import { ArrowLeft, Award, Plus, Search, Star, TrendingUp, Users, CheckCircle, Sparkles, Shield } from 'lucide-react';
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3 sm:gap-4">
              ...
              <div className="flex-1 min-w-0">
                <h1 className="text-xl sm:text-2xl font-light text-white">Skill Endorsements</h1>
                <p className="text-xs sm:text-sm text-purple-300/60">Peer validation and recognition</p>
              </div>
