...
const AuthenticatedApp = () => {
  ...
  // Show loading spinner only while checking auth (public settings are non-blocking)
  if (isLoadingAuth) {
    return (
  ...
  // Handle authentication errors — only block rendering for specific known types
