...
const KPI_CONFIG = [
  { key: 'volume', label: 'Total Volume', icon: DollarSign, color: 'text-emerald-400', border: 'border-emerald-500/30', format: v => `${v.toFixed(0)} XRP` },
  { key: 'treasury', label: 'Treasury Balance', icon: Landmark, color: 'text-blue-400', border: 'border-blue-500/30', format: v => `${v.toFixed(0)} XRP` },
