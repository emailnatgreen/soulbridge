                                ...
                                components={{
                                    code: ({ inline, className, children, ...props }) => {
                                        ...
                                        return !inline && match ? (
                                            ...
                                            <code className="px-1 py-0.5 rounded bg-white/20 text-purple-200 text-xs">
                                                {children}
                                            </code>
                                        );
                                    },
                                    a: ({ children, ...props }) => (
                                        <a {...props} target="_blank" rel="noopener noreferrer" className="text-purple-300 hover:text-purple-200">{children}</a>
                                    ),
                                    p: ({ children }) => <p className="my-1 leading-relaxed text-white/90">{children}</p>,
                                    ul: ({ children }) => <ul className="my-1 ml-4 list-disc">{children}</ul>,
                                    ol: ({ children }) => <ol className="my-1 ml-4 list-decimal">{children}</ol>,
                                    li: ({ children }) => <li className="my-0.5 text-white/90">{children}</li>,
                                }}
                            >
                                {message.content}
                            </ReactMarkdown>
