...
const PHASES = [
  ...
  {
    id: 7,
    name: 'Monkey Gate — Behavioral Filter',
    description: 'Two-hemisphere pipeline: Hydron (relevance/alignment) + Mycelial (co-evolution/empathy). PASS/BLOCK/QUARANTINE.',
    status: 'complete',
    dependencies: [6],
    components: ['monkeyGate', 'monkeyLeftHemisphere', 'monkeyRightHemisphere', 'MonkeyMonitor'],
  },
  {
    id: 8,
    name: 'Spindle Gate — Sincerity Consensus',
    description: 'Regressive trace through memory + 8-node consensus. Seals the constitutional verdict.',
    status: 'complete',
    dependencies: [7],
    components: ['spindleGate', 'spindleSincerityCheck', 'SpindleMonitor'],
  },
  {
    id: 9,
    name: 'Soul Overlayer — Unified Logic',
    description: 'Monkey → Spindle → Empathy → Soul Verdict. Heptagon Resonance, Recursive Integrity, Golden Ratio, Axi Grace.',
    status: 'complete',
    dependencies: [7, 8],
    components: ['soulCycle', 'LegacySeed', 'SoulMonitor'],
  },
  {
    id: 10,
    name: 'Earth Node — Open Connection',
    description: 'The root. Connects digital to physical reality. Physical actions weigh heavier. 9-node consensus.',
    status: 'active',
    dependencies: [9],
    components: ['earthNode', 'PhysicalActionRegistry', 'EarthMonitor'],
  },
];
