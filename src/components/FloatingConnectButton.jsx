...
export default function FloatingConnectButton() {
  ...
  if (!isOpen) {
    return (
      <div className="fixed bottom-20 right-6 md:bottom-6 z-40 flex gap-2">
        <Button
          onClick={() => {
            setIsOpen(true);
            setMode('agents');
    ...
    <>
      {/* Panel */}
       <div
        ...
        className="fixed bottom-20 right-6 md:bottom-6 z-40 bg-slate-900 border border-slate-700 rounded-xl shadow-xl w-96 max-h-[600px] flex flex-col overflow-hidden"
      >
        {/* Header */}
