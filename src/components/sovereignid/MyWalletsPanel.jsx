...
import { Wallet, RefreshCw, Trash2, ExternalLink, Eye, EyeOff, CheckCircle, AlertCircle } from 'lucide-react';
...
export default function MyWalletsPanel({ user, wallets, onRefresh }) {
  ...
  return (
    <div className="space-y-4">
      ...
      {wallets.map(wallet => (
        <div key={wallet.id} className="bg-slate-900 border border-slate-800 rounded-xl overflow-hidden">
          <div className="p-5">
