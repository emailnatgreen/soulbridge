    ...
    : [
        {
          ...
          description: 'Create, fund, and publish your DID from one place.',
          action: (
            <Link to="/SovereignID" className="inline-flex items-center gap-2 text-sm text-purple-300 hover:text-purple-200">
              <KeyRound className="w-4 h-4" /> Open Sovereign ID
            </Link>
          )
        },
        {
