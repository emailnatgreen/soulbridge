  ...
  return (
    <div className="relative">
      ...
      {isRecognized && !isPublic && (
        <div
          className={`fixed top-0 right-0 z-30 flex items-center gap-2 p-2 pr-3 bg-slate-950/95 backdrop-blur-sm border-b border-slate-800 left-0 ${isAdmin ? 'lg:left-64' : ''}`}
        >
